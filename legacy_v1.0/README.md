...
_Important Notes_
Once you have added the desired image, you may _delete_ the source image after the icon has changes as OS X - Mojave are able to save this information without using the image path.
